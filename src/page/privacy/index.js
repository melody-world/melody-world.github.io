      ...
      <div className={styles.container}>
        ...
        <div className={styles.contentWrapper}>
          <section>
            ...
            <p>
              MerryEddyHouse built the <span className={styles.appName}>{appName}</span> app as a Free app. This service
              is provided by MerryEddyHouse at no cost and is intended for use as is.
            </p>
            <p>
            ...
            <p>
              ...
              accessible at 광명찾자 unless otherwise defined in this Privacy Policy.
            </p>
          </section>
          <section>
          ...
          <section>
            ...
            <div>
              <p>
                These service do not knowingly collect personally identifiable information from children under 13 years
                of age. In the case I discover that a child under 13 has provided me with personal information, I
                immediately delete this from our servers. If you are a parent or guardian and you are aware that your
                child has provided us with personal information, please contact me so that I will be able to do the
                necessary actions.
              </p>
            </div>
          </section>
