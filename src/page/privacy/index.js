...
export default function Privacy() {
  ...
  const project = PROJECT_LIST.filter(
    (project) => project.readMore === "/" + path
  );
  ...
  console.log(path, project.length);

  return project.length > 0 ? <PrivacyContent /> : <NotFound />;
}
      ...
      <div className={styles.container}>
        ...
        <div>
          <p>
            ...
            지침을 말합니다. 코드드림은 사용자의 개인정보를 존중하며 보호하기
            위해 최선을 다하고 있습니다. <br />
            코드드림은 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를
        ...
        <div>
          ...
          <p>
            1.1. 앱 사용자의 식별을 위해 수집되는 개인정보의 항목은 다음과
            같습니다.
            <ul>
        ...
        <div>
          ...
          <p>
            2.1. 개인정보의 보유 및 이용 기간은 해당 정보의 수집 목적이
            달성되거나 사용자가 개인정보 삭제를 요청한 경우에 한정됩니다.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            3.1. 본 애플리케이션은 사용자의 개인정보를 제3자에게 제공하지
            않습니다. 다만, 법률적인 의무가 있는 경우 또는 사용자의 동의가 있는
            경우에 한하여 예외적으로 제공될 수 있습니다.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            4.1. 본 애플리케이션은 적절한 보안 조치를 이용하여 사용자의
            개인정보를 보호합니다. 이에는 암호화, 접근 제어, 네트워크 보안 등이
            포함됩니다.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            5.1. 이용자는 자신의 개인정보에 대한 열람, 정정, 삭제를 요청할 수
            있습니다. 이에 대한 절차는 애플리케이션 내 설정 화면에서 제공됩니다.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            6.1. 본 개인정보 처리방침은 법령이나 서비스의 변경사항에 따라 변경될
            수 있습니다. 변경사항이 있는 경우 애플리케이션 내 공지사항을 통해
            사용자에게 알립니다.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            7.1. 개인정보 처리방침에 관한 문의사항은 다음 연락처로 문의해주시기
            바랍니다.
          </p>
          <p>
            코드드림 :{" "}
